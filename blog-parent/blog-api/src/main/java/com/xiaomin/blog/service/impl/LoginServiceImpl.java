...
import com.xiaomin.blog.utils.JWTUtils;
...
public class LoginServiceImpl implements LoginService {
    ...
    private static final String slat="jieniyou!@#";
    @Override
    public Result login(LoginParam loginParam) {
         ...
         * 5.token放入redis当中redis  token:user信息 设置过期时间
    ...
    public Result register(LoginParam loginParam) {
         ...
         * 4.生成token
         * 5.存入redis 并返回
         * 6.注意 加上事务,一旦中间的任何过程出现的问题,注册的用户 需要回滚
         */
        String account = loginParam.getAccount();
        String password = loginParam.getPassword();
        ...
        sysUser.setAvatar("http://rdxooqqzo.hb-bkt.clouddn.com/img/avatar/handsome_boy.jpg");
    ...
    public static void main(String[] args) {
        System.out.println(DigestUtils.md5Hex("jieniyou"+slat));//f7460ba4151ecea4bda88595836c7ecb
    }
}
