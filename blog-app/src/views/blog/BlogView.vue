        ...
        <div class="me-view-card">
          ...
          <div class="me-view-author">
            ...
            <div class="me-view-info">
              ...
              <!--              <br>
               <span>article.author.avatar==>{{article.author.avatar}}</span><br>
               <span>avatar==>{{avatar}}</span><br>
               <span>article.author.id==>{{article.author.id}}</span> -->
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      title() {
        return `${this.article.title} - 文章 - 解你忧`
      }
    },
    methods: {
